...
namespace Watermelon
{
    public class MoneyStackBehaviour : MonoBehaviour
    {
        ...
        private void DisableMoneyElements()
        {
            ...
            PlayerBehaviour playerBehavior = PlayerBehaviour.GetBehavior();
        ...
        private readonly MultiText moneyMultiText = new MultiText("Деньги", "Money");
        ...
        private void PickMoney()
        {
            if (collectedMoney > 0)
            {
                ...
                FloatingTextController.SpawnFloatingText(moneyMultiText.GetText(), "+" + collectedMoney, transform.position + new Vector3(0, 6, 2), Quaternion.Euler(45, 0, 0), 1.0f);
                ...
                AdsManager.ShowInterstitial(r =>
                {
                    Debug.Log("End of money stack " + r);
                });
