...
namespace Watermelon
{
    public class LevelController : MonoBehaviour
    {
        ...
        private static PlayerBehaviour playerBehavior;
        ...
        [SerializeField] private AnimalsDatabase animalsDatabase;
        [SerializeField] private SicknessDatabase sicknessDatabase;
        [SerializeField] private NavMeshSurface navMeshSurface;

        [Space]
        [SerializeField] private GameObject purchaseZoneObject;
        [SerializeField] private GameObject tablePurchaseZoneObject;
        [SerializeField] private GameObject tableAreaPurchaseZoneObject;
        [SerializeField] private GameObject tableAreaAdButtonObject;
        [SerializeField] private GameObject purchaseAreaAdTriggerObject;
        [SerializeField] private GameObject waitingIndicatorObject;
        [SerializeField] private GameObject playerPrefabObject;
        [SerializeField] private GameObject nursePrefabObject;
        ...
        public static void OnLevelCreated(Level level)
        {
            ...
            playerBehavior = playerObject.GetComponent<PlayerBehaviour>();
