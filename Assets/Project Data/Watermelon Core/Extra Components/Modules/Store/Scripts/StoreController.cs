...
namespace Watermelon.Store
{
    public class StoreController : MonoBehaviour
    {
        ...
        public static bool BuyProduct(ProductData product, bool select = true, bool free = false)
        {
            ...
            Debug.Log("Try ads 2");
            if (product.PurchType == ProductData.PurchaseType.InGameCurrency && CurrenciesController.HasAmount(product.Currency, product.Cost))
            {
            ...
            if(product.PurchType == ProductData.PurchaseType.RewardedVideo)
            {
                Debug.Log("Start w ads");
        ...
        public static Texture GetSelectedSkin(TabType type)
        {
            return selectedProducts[type].Skin;
        }
        ...
        public static ProductData GetRandomUnlockedProduct(TabType tab)
        {
