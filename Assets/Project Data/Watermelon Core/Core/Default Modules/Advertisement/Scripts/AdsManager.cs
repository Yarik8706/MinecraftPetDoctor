...
using Project_Data.Watermelon_Core.Core.Default_Modules.Advertisement.Scripts.Providers.YandexGames;
...
namespace Watermelon
{
    ...
    public static class AdsManager
    {
        ...
        {
            new YandexHandler(AdvertisingModules.YandexGames)
        };
...
#region Rewarded Video
        ...
        public static void ShowRewardBasedVideo(AdvertisingModules advertisingModules, AdvertisingHandler.RewardedVideoCallback callback, bool showErrorMessage = true)
        {
            ...
            Debug.Log("Start Ads : " + advertisingModules);
