...
namespace Watermelon
{
    ...
    {
        [SerializeField] AdvertisingModules bannerType = AdvertisingModules.YandexGames;
        public AdvertisingModules BannerType => bannerType;

        [SerializeField] AdvertisingModules interstitialType = AdvertisingModules.YandexGames;
        public AdvertisingModules InterstitialType => interstitialType;

        [SerializeField] AdvertisingModules rewardedVideoType = AdvertisingModules.YandexGames;
